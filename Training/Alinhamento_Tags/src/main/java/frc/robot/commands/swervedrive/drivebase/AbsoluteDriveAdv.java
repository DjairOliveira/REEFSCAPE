...
//       }
//       else{
//         headingY = Math.cos(Math.toRadians(117));
//         headingX = Math.sin(Math.toRadians(117));
//       }
//     }
//     if (lookfeed.getAsBoolean())
//     {
//       if (swerve.redSide() == true) {
//         headingY = Math.cos(Math.toRadians(-140));
//         headingX = Math.sin(Math.toRadians(-140));
...
//     {
//       if (swerve.redSide() == true) {
//         headingY = Math.cos(Math.toRadians(-124));
//         headingX = Math.sin(Math.toRadians(-124));
         
//       }
//       else{
//         headingY = Math.cos(Math.toRadians(-63));
//         headingX = Math.sin(Math.toRadians(-63));
//       }
//     }
