...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public void periodic()
  {
    ...
    //   directionPilotCtr=1;
    //   SmartDashboard.putString("Autonomo", "Enable");
    // }
    // if (!DriverStation.isAutonomousEnabled() && directionPilotCtr==1) {
    //   PoseMov = new Rotation3d(0, 0, 0);  /// Orientação com base no ligar do robô
    //   SmartDashboard.putString("Autonomo", "Disable");
    //   directionPilotCtr=2;
    // }
    // if(DriverStation.isTeleopEnabled() && directionPilotCtr==2){
    //   swerveDrive.setGyroOffset(PoseMov);
    //   SmartDashboard.putString("Iai entrou?", "To memo nenem");
    //   directionPilotCtr=0;
    // }
    ...
    if(alliance == Alliance.Red){
      SmartDashboard.putString("Aliança", "Vermeia");
    }
    if(alliance == Alliance.Blue){
      SmartDashboard.putString("Aliança", "Azules");
    }
  
    SmartDashboard.putNumber("To aki mane", Timer.getFPGATimestamp());
